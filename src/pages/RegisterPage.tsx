  ...
  return (
    <div className="relative min-h-screen bg-surface overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, rgba(63,255,139,0.06) 0%, transparent 70%)' }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="flex-1 flex flex-col justify-end lg:justify-center px-8 pt-10 pb-6 lg:px-16 lg:pb-16">
          ...
          {/* Badge */}
          <div
            className="inline-flex items-center gap-2 rounded-full px-4 py-2 w-fit mb-5"
          ...
          <p className="text-on-surface-variant text-base lg:text-lg max-w-md leading-relaxed">
            Crie sua conta gratuita e comece a registrar cada manutenção com precisão.
          </p>
        </div>
...
function CarIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#005d2c" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
